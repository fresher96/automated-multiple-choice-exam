 ...
 * @author Farouk
 */
public class QuestionAdder_deprected extends javax.swing.JFrame {

    /**
     * Creates new form QuestionAdder_deprected
     */
    JPanel pnla, pnlb;
    JPanel pnl;
    Box btns;
    ...
    public QuestionAdder_deprected() {
        initComponents();
...
//        jScrollPane1.validate();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(QuestionAdder_deprected.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new QuestionAdder_deprected().setVisible(true);
            }
        });
    }
